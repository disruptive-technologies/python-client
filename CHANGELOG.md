...
# v1.6.8
### Fixed
- [#136](https://github.com/disruptive-technologies/python-client/pull/136) Explicit event attributes and types on `Reported` class.
...
# v1.6.5
### Fixed
- [#133](https://github.com/disruptive-technologies/python-client/pull/133) Added missing state on `ProbeWireStatus` event.
