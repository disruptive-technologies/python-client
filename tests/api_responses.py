auth_token_fresh = {"expires_in": 3600, "access_token": ""}

auth_token_expired = {"expires_in": 0, "access_token": ""}

ccon = {
    "name": "projects/c0md8mm0c7bet3vic78g/devices/emuc909fk1qdqebrvv2jqv0",
    "type": "ccon",
    "productNumber": "100011",
    "labels": {"name": "ccon", "virtual-sensor": ""},
    "reported": {
        "connectionStatus": {
            "connection": "CELLULAR",
...
humidity_sensor = {
    ...
    "labels": {"name": "humidity", "new-label": "99", "virtual-sensor": ""},
    "reported": {
        "networkStatus": {
            "signalStrength": 99,
            "rssi": 0,
            ...
            "cloudConnectors": [
                {"id": "emulated-ccon", "signalStrength": 99, "rssi": 0}
            ],
        ...
        "touch": {"updateTime": "2021-03-13T16:05:35.380533Z"},
    },
}
...
proximity_sensor = {
    ...
    "labels": {"name": "proximity", "virtual-sensor": ""},
    "reported": {
        "networkStatus": {
            "signalStrength": 99,
            "rssi": 0,
        ...
        "touch": {"updateTime": "2021-03-13T16:05:45.281488Z"},
    },
}
...
temperature_sensor = {
    ...
    "reported": {
        ...
        "temperature": {
            ...
            "isBackfilled": False,
            "samples": [
                {"value": -27, "sampleTime": "2021-03-13T16:05:47.722334Z"}
            ],
            "updateTime": "2021-03-13T16:05:47.722334Z",
        },
        "touch": {"updateTime": "2021-03-13T16:05:53.015325Z"},
    },
}
...
touch_sensor = {
    ...
    "labels": {"name": "touch", "new-label": "99", "virtual-sensor": ""},
    "reported": {
        "networkStatus": {
            "signalStrength": 99,
            "rssi": -50,
            ...
            "cloudConnectors": [
                {"id": "emulated-ccon", "signalStrength": 99, "rssi": -50}
            ],
            "transmissionMode": "LOW_POWER_STANDARD_MODE",
        },
        "batteryStatus": {
        ...
        "touch": {"updateTime": "2021-03-13T16:05:55.084433Z"},
    },
}
...
water_present_sensor = {
    ...
    "labels": {"name": "water", "virtual-sensor": ""},
    "reported": {
        "networkStatus": {
            "signalStrength": 99,
            "rssi": 0,
        ...
        "touch": {"updateTime": "2021-03-13T16:06:05.526762Z"},
    },
}
...
proximity_counter_sensor = {
    ...
    "labels": {"name": "proximity counter", "virtual-sensor": ""},
    "reported": {
        "networkStatus": {
            "signalStrength": 99,
            "rssi": 0,
        ...
        "touch": {"updateTime": "2021-03-13T16:10:32.184589Z"},
    },
}
...
touch_count_sensor = {
    ...
    "labels": {"name": "touch counter", "virtual-sensor": ""},
    "reported": {
        "networkStatus": {
            "signalStrength": 99,
            "rssi": 0,
        ...
        "touch": {"updateTime": "2021-03-13T16:11:43.902157Z"},
    },
}
...
configured_data_connector = {
    ...
    "labels": ["name", "custom-label-01", "custom-label-02"],
    "httpConfig": {
        "url": "https://584087e0a1fa.eu.ngrok.io/api/endpoint",
...
projects = {"nextPageToken": "", "projects": [small_project, empty_project]}
...
touch_event = {
    ...
    "eventType": "touch",
    "data": {"touch": {"updateTime": "2019-05-16T08:13:15.361624Z"}},
...
temperature_event = {
    ...
    "data": {
        "temperature": {
            ...
            "isBackfilled": False,
            "samples": [
                {"value": 24.9, "sampleTime": "2019-05-16T08:15:18.318751Z"}
            ],
...
labels_changed_event = {
    ...
    "data": {
        "added": {"label-key": "label-value"},
        "modified": {"label-key": "new-label-value"},
        "removed": ["remove-key1", "remove-key2"],
    },
    "timestamp": "1970-01-01T00:00:00Z",
}
...
co2_event = {
    ...
    "eventType": "co2",
    "data": {"co2": {"ppm": 526, "updateTime": "2022-01-27T15:50:34.471000Z"}},
...
stream_networkstatus_event = (
    b'{"result":{"event":{"eventId":"c1vtubtd83it'
